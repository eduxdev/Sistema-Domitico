...
/**
 * API Endpoint: Obtener datos en tiempo real para MQ2 (Gas)
...
export async function GET(request: Request) {
  try {
    ...
    // Obtener las últimas lecturas del sensor MQ2
    ...
    if (error) {
      console.error('Error obteniendo datos MQ2:', error)
      return NextResponse.json(
    ...
    console.error('Error en API chart-data:', error)
    return NextResponse.json(
